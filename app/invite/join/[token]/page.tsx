                        ...
                        <CardContent className="space-y-6">
                            ...
                            {(instance.venue || instance.address || instance.location) && (
                                <div className="flex items-start text-gray-700">
                                    <MapPin className="h-5 w-5 mr-3 text-purple-600 mt-1" />
                                    <div>
                                        {instance.venue && <div className="font-semibold">{instance.venue}</div>}
                                        {instance.address && <div className="text-sm">{instance.address}</div>}
                                        {!instance.venue && !instance.address && instance.location && <div>{instance.location}</div>}
                                    </div>
                                </div>
                            )}

            ...
            <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Guest Tools - Calendar & QR */}
                        <div className="space-y-4">
                            <CalendarIntegration
                                instanceId={instance.id}
                                activityName={instance.customTitle || instance.activity.name}
                            />
                            {/* Show QR Code if space available */}
                            {(!instance.capacity || ((instance.publicRSVPs?.length || 0) + (instance.hostAttending ? 1 : 0) < instance.capacity)) && (
                                <QRCodeGenerator
                                    url={`${typeof window !== 'undefined' ? window.location.origin : ''}/event/${instance.id}`}
